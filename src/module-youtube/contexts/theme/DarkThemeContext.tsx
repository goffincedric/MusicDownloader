...
import {
  ...
  DarkThemeReducer,
  DarkThemeState,
} from './DarkThemeReducer';
import { DarkThemeAction } from './DarkThemeActions';

export const DarkThemeContext = createContext<DarkThemeState>(
  initialDarkThemeState
);
export const DarkThemeDispatchContext = createContext<
  Dispatch<DarkThemeAction>
>({} as Dispatch<DarkThemeAction>);
...
export const DarkThemeProvider = ({ children }: PropsWithChildren) => {
  ...
  return (
    <DarkThemeContext.Provider value={state}>
      <DarkThemeDispatchContext.Provider value={dispatch}>
        {children}
      </DarkThemeDispatchContext.Provider>
